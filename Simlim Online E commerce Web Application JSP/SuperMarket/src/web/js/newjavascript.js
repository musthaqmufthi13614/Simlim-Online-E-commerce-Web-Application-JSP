...
})(
    {
                    ...
                    (c.prototype.add = function (a) {
                        ...
                        return (
                            b ||
                                ((b = new d(a)),
                                b.isValid() &&
                                    ((j = this._items.push(b) - 1),
                                    b.on("change", function (a, b) {
                                        h.save(), h.fire("change", j, a, b);
                                    }),
                                    this.save())),
                            b && this.fire("add", j, b, k),
                            j
                        );
                    }),
        ...
        12: [
            function (a, b) {
                ...
                (i.render = function (a) {
                    (d = i.config = h.load(a)),
                        (c = i.cart = new f(d.name, d.duration)),
                        (e = i.view = new g({ config: d, cart: c })),
                        c.on("add", e.addItem, e),
                        c.on("change", e.changeItem, e),
                        c.on("remove", e.removeItem, e),
                        c.on("destroy", e.hide, e);
                }),
                    (i.reset = function () {
        ...
        13: [
            function (a, b) {
                "use strict";
                function c(a) {
                    (a.quantity = g.quantity(a.quantity)),
                        (a.amount = g.amount(a.amount)),
                        (a.href = g.href(a.href)),
                        (this._data = a),
                        (this._options = null),
                        (this._discount = null),
                        (this._amount = null),
                ...
                f(c.prototype, e.prototype),
                    ...
                    (c.prototype.discount = function (a) {
                        ...
                        return (
                            this._discount ||
                                ((h = 0),
                                (e = parseInt(this.get("discount_num"), 10) || 0),
                                (f = Math.max(e, this.get("quantity") - 1)),
                                void 0 !== this.get("discount_amount")
                                    ? ((b = g.amount(this.get("discount_amount"))), (h += b), (h += g.amount(this.get("discount_amount2") || b) * f))
                                    : void 0 !== this.get("discount_rate") && ((c = g.amount(this.get("discount_rate"))), (i = this.amount()), (h += (c * i) / 100), (h += (g.amount(this.get("discount_rate2") || c) * i * f) / 100)),
                                (this._discount = h)),
                            d(this._discount, a)
                        );
                    }),
        ...
        22: [
            function (a, b) {
                ...
                function c(a) {
                    var b;
                    (this.el = b = document.createElement("div")),
                        (this.model = a),
                        (this.isShowing = !1),
                        (b.id = d.name),
                        d.parent.appendChild(b),
                        h.inject(document.getElementsByTagName("head")[0], d.styles),
                        e.add(document, "ontouchstart" in window ? "touchstart" : "click", i.click, this),
                        e.add(document, "keyup", i.keyup, this),
                        e.add(document, "readystatechange", i.readystatechange, this),
                        e.add(window, "pageshow", i.pageshow, this);
                }
                var d = a("./config"),
                    e = a("./util/events"),
                    f = a("./util/template"),
                ...
                (c.prototype.redraw = function () {
                    e.remove(this.el.querySelector("form"), "submit", this.model.cart.checkout, this.model.cart),
                        (this.el.innerHTML = f(d.template, this.model)),
                        e.add(this.el.querySelector("form"), "submit", this.model.cart.checkout, this.model.cart);
                }),
                    ...
                    (c.prototype.bind = function (a) {
                        var b = this;
                        return j.COMMANDS[a.cmd.value]
                            ? a.hasMinicart
                                ? !1
                                : ((a.hasMinicart = !0),
                                  a.display
                                      ? e.add(a, "submit", function (a) {
