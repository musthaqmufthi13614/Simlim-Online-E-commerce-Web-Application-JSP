												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="products.html"><img title=" " alt=" " src="images/product_images/<%= image %>" width="100px" /></a>		
															<p><%= product_name %></p>
															<div class="stars">
                                                                                                                            <%
															...
															<h4>Rs.<%= show_price%> <span> Rs. <%= cutted_price %></span></h4>
														</div>
...
<%
                                                                    ...
                                                                    while (rst.next()) //next read the current record and move to next,if end of record found it return false
                                                                {
                                                                    ...
                                                                    String addItemURL =
                                                                                    ...
                                                                                    "productCode="+URLEncoder.encode(product_id)+
                                                                                    "&description="+URLEncoder.encode(description)+
                                                                                    "&quantity=1"+
                                                                                    "&price="+URLEncoder.encode(""+show_price);
